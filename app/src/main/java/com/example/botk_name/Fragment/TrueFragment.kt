...
import com.example.botk_name.databinding.FragmentTrueBinding
...
class TrueFragment : Fragment() {
    lateinit var binding:FragmentTrueBinding
    ...
    override fun onCreateView(
     ...
     /*   val view= inflater.inflate(R.layout.fragment_true, container, false)
        binding=FragmentTrueBinding.bind(view)
        ...
        binding.rvTrue.adapter = adapeter
*/
